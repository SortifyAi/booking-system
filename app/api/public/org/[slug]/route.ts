...
import { demoLocations, demoOrganization, isDemoBookingSlug } from '@/lib/public-demo'
...
export async function GET(
  ...
  if (isDemoBookingSlug(slug)) {
    return NextResponse.json({ org: demoOrganization, locations: demoLocations })
  }
